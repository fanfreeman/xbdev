 ...
 * atomfiles ecosystem. Furthermore, this class is responsible for installing,
...
class Atom_App{
	...
	public static function loadApps(){
		...
		// The rest comes here
		$apps = Atom_Appconfig::getApps();
		foreach( $apps as $app ){
			if( self::isEnabled( $app )){
				if(is_file(Atom::$SERVERROOT.'/apps/'.$app.'/appinfo/app.php')){
	...
	public static function isEnabled( $app ){
		if( 'yes' == Atom_Appconfig::getValue( $app, 'enabled' )){
			return true;
		}
	...
	public static function enable( $app ){
		if(!Atom_Installer::isInstalled($app)){
			Atom_Installer::installShippedApp($app);
		}
		Atom_Appconfig::setValue( $app, 'enabled', 'yes' );
	}
	...
	public static function disable( $app ){
		Atom_Appconfig::setValue( $app, 'enabled', 'no' );
	}
