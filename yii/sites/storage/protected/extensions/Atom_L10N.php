...
class Atom_L10N{
	...
	public function __construct($app, $lang = null){
		...
		if(array_key_exists($app.'::'.$lang, self::$cache)){
			...
			if(file_exists(Atom::$SERVERROOT.'/core/l10n/l10n-'.$lang.'.php')){
				// Include the file, save the data from $CONFIG
				include(Atom::$SERVERROOT.'/core/l10n/l10n-'.$lang.'.php');
	...
	public static function findLanguage($app = null){
		...
		if(Atom_User::getUser() && Atom_Preferences::getValue(Atom_User::getUser(), 'core', 'lang')){
			$lang = Atom_Preferences::getValue(Atom_User::getUser(), 'core', 'lang');
			self::$language = $lang;
	...
	protected static function findI18nDir($app){
		// find the i18n dir
		$i18ndir = Atom::$SERVERROOT.'/core/l10n/';
		if($app != ''){
			// Check if the app is in the app folder
			if(file_exists(Atom::$SERVERROOT.'/apps/'.$app.'/l10n/')){
				$i18ndir = Atom::$SERVERROOT.'/apps/'.$app.'/l10n/';
			}
			else{
				$i18ndir = Atom::$SERVERROOT.'/'.$app.'/l10n/';
			}
		}
		return $i18ndir;
	}
