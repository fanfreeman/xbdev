...
class Atom_Config{
	...
	private static function readData(){
		...
		if( !file_exists( Atom::$SERVERROOT."/config/config.php" )){
			return false;
		}

		// Include the file, save the data from $CONFIG
		include( Atom::$SERVERROOT."/config/config.php" );
	...
	public static function writeData(){
		...
		// Write the file
		$result=@file_put_contents( Atom::$SERVERROOT."/config/config.php", $content );
		if(!$result) {
