...
<input type="hidden" name="install" value="true" />
	...
	<fieldset>
		...
		<p class="infield">
			...
			<input type="text" name="adminlogin" id="adminlogin" value="<?php print Atom_Helper::init_var('adminlogin'); ?>" autocomplete="off" autofocus required />
		</p>
		<p class="infield">
			<label for="adminpass" class="infield"><?php echo $l->t( 'Password' ); ?></label>
			<input type="password" name="adminpass" id="adminpass" value="<?php print Atom_Helper::init_var('adminpass'); ?>" required />
		</p>
	</fieldset>
	...
	<fieldset id="datadirField">
		...
		<div id="datadirContent">
			...
			<input type="text" name="directory" id="directory" value="<?php print Atom_Helper::init_var('directory', $_['directory']); ?>" />
		</div>
	</fieldset>
	...
	<fieldset id='databaseField'>
		...
		<?php else: ?>
		<input type="radio" name="dbtype" value="sqlite" id="sqlite" <?php Atom_Helper::init_radio('dbtype', 'sqlite', 'sqlite'); ?>/>
		...
		<?php else: ?>
		<input type="radio" name="dbtype" value="mysql" id="mysql" <?php Atom_Helper::init_radio('dbtype','mysql', 'sqlite'); ?>/>
		...
		<input type="radio" name="dbtype" value='pgsql' id="pgsql" <?php Atom_Helper::init_radio('dbtype','pgsql', 'sqlite'); ?>/>
		<?php endif; ?>
		<?php endif; ?>
		</div>
		...
		<div id="use_other_db">
			<p class="infield">
				...
				<input type="text" name="dbuser" id="dbuser" value="<?php print Atom_Helper::init_var('dbuser'); ?>" autocomplete="off" />
			</p>
			<p class="infield">
				<label for="dbpass" class="infield"><?php echo $l->t( 'Database password' ); ?></label>
				<input type="password" name="dbpass" id="dbpass" value="<?php print Atom_Helper::init_var('dbpass'); ?>" />
			</p>
			<p class="infield">
				<label for="dbname" class="infield"><?php echo $l->t( 'Database name' ); ?></label>
				<input type="text" name="dbname" id="dbname" value="<?php print Atom_Helper::init_var('dbname'); ?>" autocomplete="off" />
			</p>
		</div>
		<?php endif; ?>
		<p class="infield">
			<label for="dbhost" class="infield"><?php echo $l->t( 'Database host' ); ?></label>
			<input type="text" name="dbhost" id="dbhost" value="<?php print Atom_Helper::init_var('dbhost', 'localhost'); ?>" />
		</p>
	</fieldset>
